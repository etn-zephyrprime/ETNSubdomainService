...
// Event-building/lot-valuation primitives — extracted to pnlEventBuilder.js (verbatim, no logic
// changes) so pnlSnapshotService.js (Core tier's live PnL dashboard feature) can build the exact
// same FIFO events and value lots the exact same way this file does, without a second,
// divergence-prone implementation. See that file's own header comment.
import {
  NATIVE_SENTINEL,
  transferToEvent,
  NFT_ASSET_TYPES,
