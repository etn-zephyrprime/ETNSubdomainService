...
// see coming.
export default function CoreTierPortfolio({ wallet, getAuthParams, onSelectToken, onViewDemo, coreTierAccess, walletFilter }) {
    ...
    <DashboardPanel>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, marginBottom: 12, flexWrap: "wrap" }}>
        ...
        {/* Visible to literally anyone — including a visitor with no wallet connected at all —
            whenever they don't already have real access; hidden once they do, since a real member
            has no reason to look at a demo of their own feature. Now navigates to its own page
            (see DashboardApp.jsx's "demo" tab) rather than expanding in place here — squeezed
            inside this panel alongside the connect/subscribe gate, it read as cramped and missing
            sections a real member's Portfolio view has plenty of room for. */}
        {!hasAccess && (
          <button
            type="button"
            onClick={onViewDemo}
